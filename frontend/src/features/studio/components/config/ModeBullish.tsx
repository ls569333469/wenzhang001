...
export function ModeBullish({ lengthType, setLengthType, customLength, setCustomLength }: ModeBullishProps) {
    return (
        <>
            {/* 风格提示 — 锁定吹捧体 */}
            <section className="space-y-2">
                ...
                <div className="bg-pink-50 border border-pink-200 rounded-xl px-4 py-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <div className="text-sm font-semibold text-pink-700">吹捧体</div>
                            <div className="text-xs text-pink-500">正面解读 · 积极肯定</div>
                        </div>
                    </div>
                </div>
            </section>
